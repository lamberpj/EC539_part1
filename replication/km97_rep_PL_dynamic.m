...
residual = zeros(4, 1);
T26 = params(6)/(y(4)+params(1)-y(7)/params(4));
lhs =y(4);
rhs =y(7)/params(4)+y(3)-params(5);
residual(1)= lhs-rhs;
lhs =y(3);
...
T66 = (y(4)+params(1)-y(7)/params(4))*(y(4)+params(1)-y(7)/params(4));
  g1(1,3)=(-1);
  g1(1,4)=1;
  g1(1,7)=(-(1/params(4)));
  g1(2,1)=(-((1-params(6))*params(2)+T26*(y(4)+params(3)*(1+x(it_, 1))+params(2)*params(1))));
  g1(2,3)=1;
  g1(2,4)=(-((y(1)*(y(4)+params(3)*(1+x(it_, 1))+params(2)*params(1))-params(4)*y(2))*(-params(6))/T66+y(1)*T26));
  g1(2,7)=(-((y(1)*(y(4)+params(3)*(1+x(it_, 1))+params(2)*params(1))-params(4)*y(2))*(-(params(6)*(-(1/params(4)))))/T66));
  g1(2,2)=(-(T26*(-params(4))));
  g1(2,8)=(-(T26*y(1)*params(3)));
